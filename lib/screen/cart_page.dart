      ...
      children: [
        ...
        Expanded(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        "$quantity",
                        style: TextStyle(fontSize: 20, color: Colors.black),   // change color to black
                      )
                    ],
                  )
                ],
            ...
            IconButton(
              icon: Icon(Icons.close, color: Colors.black),    // change color to black // to delete item : '×' <- icon
              onPressed: onTap,
            )
          ],
        )),
